...
if ($guest_account == false) { // Not a Guest Account
  ...
  define('NAVBAR_TITLE', 'Enter billing information');
}
// guest_account end
...
// guest_account start
define('HEADING_TITLE_GUEST', 'Billing Details');
// guest_account end

define('TEXT_ORIGIN_LOGIN', 'Please Enter your Billing details below.');
