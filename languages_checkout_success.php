...
define('TEXT_SUCCESS', 'Your order should arrive at their destination within 5 working days.');
...
define('TEXT_CONTACT_STORE_OWNER', 'If you have any questions, please contact us by <a href="' . tep_href_link(FILENAME_CONTACT_US) . '">clicking here</a>.');
...
// Guest account start
define('TEXT_GUEST_ORDERS', 'Your comments to guest customers.');
?>