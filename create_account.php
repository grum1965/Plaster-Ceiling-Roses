...
// guest account
  if (isset($HTTP_GET_VARS['guest_account'])){
  $guest_account = true;
  }
// guest account end
...
// Guest Account Start
    if ($guest_account == true) $sql_data_array['guest_flag'] = '1';
...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="400" >
  <tr>
    <td height="137" bgcolor="#B2B2B2"> 

</td>
  </tr></table>
<div class="contentContainer" style="margin-left:20px;">
<h1><?php // Added Guest Account
			if ($guest_account) {
...
<?php echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'), 'post', 'onsubmit="return check_form(create_account);"', true) . tep_draw_hidden_field('action', 'process') . tep_draw_hidden_field('guest_account', $guest_account); ?>
